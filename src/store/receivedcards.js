  ...
  effects: (dispatch) => ({
    ...
    getReceivedCardsAsync: async ({receiverName, searchText, pageNumber, pageSize,sortDirection ,sortBy}) => {
      try {
        ...
        const url =` http://localhost:9090/card?receiverName=${receiverName}&searchText=${searchText}&page=${pageNumber}&Size=${pageSize}&sortDirection=${sortDirection}&sortValue=${sortBy}`;
...
console.log(url);
    ...
    getReceivedAppreciationAsync: async ({receiverName, category,searchText, pageNumber, pageSize,sortDirection ,sortBy}) => {
      try {
        ...
        const url =` http://localhost:9090/card/category/received?receiverName=${receiverName}&searchText=${searchText}&category=${category}&page=${pageNumber}&Size=${pageSize}&sortDirection=${sortDirection}&sortValue=${sortBy}`;
