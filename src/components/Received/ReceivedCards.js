    ...
    <IconButton sx={{color:"#FCFCFC"}}>
      ...
      >
        ...
        >
          ...
          {selectedButton === "All" && (
            <Table>
              ...
              {receivedcards?.receivedcardsData?.length === 0 ? (
                <TableBody>
                  <TableRow>
                ...
                <TableBody className="custom-table-body">
                  {receivedcards?.receivedcardsData?.receivedCards && receivedcards?.receivedcardsData?.receivedCards
                    .map((row, rowIndex) => {
          ...
          {selectedButton === "Appreciation" && (
            <Table>
              ...
              {receivedcards?.receivedAppreciationData?.length=== 0 ? (
                <TableBody>
                  <TableRow>
                    <TableCell colSpan={columns.length} align="center">
                      You have not received any card yet.
                ...
                <TableBody className="custom-table-body">
                  {receivedcards?.receivedAppreciationData && receivedcards?.receivedAppreciationData
          ...
          {selectedButton === "Thanking" && (
            <Table>
              ...
              {receivedcards?.receivedThankingData?.length=== 0 ? (
                <TableBody>
                  <TableRow>
                    <TableCell colSpan={columns.length} align="center">
                      You have not received any card yet.
                ...
                <TableBody className="custom-table-body">
                  {receivedcards?.receivedThankingData && receivedcards?.receivedThankingData
        ...
        <TablePagination
          ...
          count={
            selectedButton === "All"
              ? receivedcards?.receivedcardsData?.receivedCards?.length
              : selectedButton === "Appreciation"
              ?  receivedcards?.receivedAppreciationData?.length
              : selectedButton === "Thanking"
              ?  receivedcards?.receivedThankingData?.length
